...
<head>
  ...
  <script type="text/javascript" src="../js/jquery.quicksearch.js"></script>
        <script type="text/javascript">
			$(function () {
                                $('input#id_busqueda').quicksearch('table#tabla_lugares tbody tr');
                        });
  </script>
...
<h2>Buscar Lugar o cargo</h2>

<p>Ingrese algún patrón a buscar:
<form action="#">
    <fieldset>
...
$sql= "SELECT `anexo`, `nombre`, `unidad`, `localidad`, `centro_de_costo`
...
<?php else : ?>
    ...
    <table id="tabla_lugares" class="ui-widget ui-widget-content table table-striped table-bordered">
