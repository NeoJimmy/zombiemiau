...
<div id="content">
    ...
    $sql= "INSERT INTO `guia_lugaresycargos`
    (`idguia_lugaresycargos`, `anexo`, `nombre`, `unidad`, `localidad`, `centro_de_costo` )
    VALUES (NULL, '{$_POST['anexo']}', '{$_POST['nombre']}', '{$_POST['unidad']}', '{$_POST['localidad']}', '{$_POST['centro_de_costo']}');";
    ...
    if (! $result){
                    ...
                    ?>
                    <br>
                    <a href="admin_lugaresycargos.php">Volver a Agenda</a><br><br>
                    <?php
                    exit();
                  }

    echo "Fila Agregada.<br>";
    echo "<a href='admin_lugaresycargos.php'>Volver a Lugares y cargos</a><br><br>";
    }

    ?>

    <a class="btn" href="admin_lugaresycargos.php">volver</a>

    <h2>Nuevo registro</h2>

    <form id="myform"  action='' method='POST'>
    <fieldset>
    <legend>Datos de la gu&iacute;a de lugares y cargos</legend>
