...
<form id='form' action='' method='POST'>
    ...
    <select name="accion">
        ...
        <option value=actualizar>Actualizar estado</option>
    </select></p>
    <p><b>Observaci&oacute;n:</b><br>
    <textarea name="observacion" cols=50 rows=4></textarea>
    </p>
    <p><input type='submit' class="btn btn-primary" value='Guardar'><input type='hidden' value='1' name='submitted'>
<?php
...
if (isset($_POST['submitted'])) {
	...
	if(isset($_POST['accion']) && $_POST['accion']!="ninguno")
	{
		...
		if (isset($_POST['observacion'])){
	        ...
	        VALUES (NULL, $nro_ot, 'EJECUCIÓN',NOW(), NULL, '".$_POST['observacion']."');";
		}else {
			$sql = "INSERT INTO `historial_ot`
	        (`idhistorial_ot`, `orden_de_trabajo_idorden_de_trabajo`, `estado`, `inicio`, `termino`, `observacion`)
	        VALUES (NULL, $nro_ot, 'EJECUCIÓN',NOW(), NULL, NULL);";		
		}
