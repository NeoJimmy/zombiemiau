...
<h2>Revisar &oacute;rdenes de trabajo en evaluaci&oacute;n t&eacute;cnica</h2>
...
if (isset($_POST['submitted'])) {
	...
	if(isset($_POST['accion']) && $_POST['accion']!="ninguno")
	{
        ...
        VALUES (NULL, $nro_ot, 'EVALUACIÓN COMERCIAL',NOW(), NULL, NULL);";
    ...
    //Parametro obtenido del combobox
     $sql= "SELECT `idorden_de_trabajo`, `nombre`, `apellido`, `anexo`, `ciudad`, `faena`, `area`, `tipo_ot`, `subtipo_ot`, `descripcion`, `observaciones` , `evaluacion_tecnica` 
       ...
       WHERE  `estado` = 'EVALUACIÓN TÉCNICA' AND `idorden_de_trabajo` = `orden_de_trabajo_idorden_de_trabajo`  AND `termino` IS NULL " ;    
