...
<form id='formEditar' action='' method='POST'>
  <p><label>Rut:</label><input type='text' name='rut' value='<?php echo stripslashes($row['rut']) ?>' class="required rut">
  <p><label>Nombre:</label><input type='text' name='nombre_us' value='<?php echo stripslashes($row['nombre']) ?>' class="required">
  <p><label>Contrase&ntilde;a:</label><input type='text' name='contrasena' value='' class="required">
  <p><label>E-mail:</label><input type='text' name='email' value='<?php echo stripslashes($row['email']) ?>' class="required email">
